    ...
    <div class="container">
        ...
        <div class="row mb-1">
            ...
            <div class=" col-sm-12 col-md-12 col-lg-4 text-center">
                <div class="h2">Faire d'internet un Outil d'éducation</div>
            </div>
            <div class=" col-sm-6 col-md-6 col-lg-2 ">
                <div class="h5 fw-bold">EasyAccess</div>
                <div><a href="../accueil/index.php" class="text-decoration-none text-white fw-bold">Accueil</a></div>
                <div><a href="../about/" class="text-decoration-none text-white fw-bold">A propos</a></div>
                <div><a href="../forum/" class="text-decoration-none text-white fw-bold">Forum</a></div>
            </div>

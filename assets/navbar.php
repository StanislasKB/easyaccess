  ...
  <div class="container py-2">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="dd-contenT text-dark bg-light">
        ...
        <li class="nav-item">
          <a class="nav-link active text-white" aria-current="page" href="../Jeu/accueil_jeu.php">Jeux</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active text-white text-nowrap" aria-current="page" href="../about/">A propos</a>
        </li>
      </ul>
      <form class="d-flex" action="/search/index.php">
        <input class="form-control me-2" type="search" name="epreuve" required placeholder="Rechercher" aria-label="Search">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
             ...
             if(isset($_SESSION['id'])){
              ?>
                <li><a class="dropdown-item text-dark" href="../dashboard/dashboard/my-profile.php">Profil</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item text-dark" href="../dashboard/dashboard/">Tableau de bord</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item text-dark" href="../dashboard/dashboard/logout.php">Se déconnecter</a></li>
              <?php
             }else{
              ?>
                <li><a class="dropdown-item text-dark" href="../login/">Se connecter</a></li>
              <li><a class="dropdown-item text-dark" href="../register/">S'inscrire</a></li>
              <?php
             }
             ?>
...
if(isset($_SESSION['id'])){
    ...
    if($nadmin>0){
        ?>
        <a href="/admin/" class="btn btn-primary position-fixed bottom-0 left-0 m-2">Admin</a>
        <?php
    }
}?>
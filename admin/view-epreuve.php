...
$requete=$bdd->prepare('SELECT url FROM epreuves WHERE id_epreuve=?');
$requete->execute([htmlspecialchars($_GET['epreuve'])]);
$data=$requete->fetch();
?>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="container m-0 me-2 ms-2">
                    <embed src="../dashboard/dashboard/epreuves/<?=$data['url'] ?>" class="w-100 mt-5" style="height:100vh ;" type="">
            </div>
        </div>
    </div>
    </div>
